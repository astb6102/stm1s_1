...
#define RS                      3.02 /* Stator resistance , ohm*/
#define LS                      0.000126 /* Stator inductance, H
...
#define MOTOR_MAX_SPEED_RPM     6200 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  1.8 /*!< Volts RMS ph-ph /kRPM */
#define NOMINAL_CURRENT_A       1.4

#define ID_DEMAG_A              -1.4 /*!< Demagnetization current */
